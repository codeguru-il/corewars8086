 ...
 * @author Erdem Guven
 */
public class CpuState implements Device {
    ...
    public AbstractAddress getCSIP(Address address) {
        return address.newAddress(m_cs, m_ip);
    }
    public AbstractAddress getSSSP(Address address) {
    ...
    public void setAL(byte value) {
        m_ax &= 0xFF00;
        m_ax |= Byte.toUnsignedInt(value);
    }
    public void setBL(byte value) {
        m_bx &= 0xFF00;
        m_bx |= Byte.toUnsignedInt(value);
    }
    public void setCL(byte value) {
        m_cx &= 0xFF00;
        m_cx |= Byte.toUnsignedInt(value);
    }
    public void setDL(byte value) {
        m_dx &= 0xFF00;
        m_dx |= Byte.toUnsignedInt(value);
    }
    public void setAH(byte value) {
        m_ax &= 0x00FF;
        m_ax |= (Byte.toUnsignedInt(value) << 8);
    }
    public void setBH(byte value) {
        m_bx &= 0x00FF;
        m_bx |= (Byte.toUnsignedInt(value) << 8);
    }
    public void setCH(byte value) {
        m_cx &= 0x00FF;
        m_cx |= (Byte.toUnsignedInt(value) << 8);
    }
    public void setDH(byte value) {
        m_dx &= 0x00FF;
        m_dx |= (Byte.toUnsignedInt(value) << 8);
    }
    ...
    public int getBomb1Count() {
        return m_bomb1count;
    }
    public void setBomb1Count(int value) {
        m_bomb1count = value;
    }
    public int getBomb2Count() {
        return m_bomb2count;
    }
    public void setBomb2Count(int value) {
        m_bomb2count = value;
    }
    ...
    private int m_bomb1count;
    private int m_bomb2count;
