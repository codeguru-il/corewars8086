...
public class IndirectAddressingDecoder {
	 ...
	 */
	public AbstractAddress getMemAddress() {
		return m_memAddress;
	}
	 ...
	 * @param value    Value to set.
	 */
	public void setMem16(int value) throws MemoryException {
		if (m_memAddress != null) {
	 ...
	 * @throws MemoryException on any error while reading from memory.
	 */
	private AbstractAddress getMode0Address() throws MemoryException {
		switch (m_memIndex) {
			case 0:
	 ...
	 * @throws MemoryException on any error while reading from memory.
	 */
	private AbstractAddress getMode1Address() throws MemoryException {
		switch (m_memIndex) {
			case 0:
				return newAddress(RegisterIndexingDecoder.DS_INDEX,
	 ...
	 * @throws MemoryException on any error while reading from memory.
	 */
	private AbstractAddress getMode2Address() throws MemoryException {
		switch (m_memIndex) {
			case 0:
				return newAddress(RegisterIndexingDecoder.DS_INDEX,
	 ...
	 */
	private AbstractAddress getMode3Address() {
		return null;
	}
	...
	AbstractAddress newAddress(int segIndex, int offset){
		if(forcedSegReg>=0){
	...
	private AbstractAddress m_memAddress;
}
